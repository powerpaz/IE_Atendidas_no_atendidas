...
(() => {
  ...
  viol: (window.LAYER_SOURCES && window.LAYER_SOURCES.violencia) ? window.LAYER_SOURCES.violencia : 'data/total_casos_violencia.geojson',
  otras: (window.LAYER_SOURCES && window.LAYER_SOURCES.otrasNacionalidades) ? window.LAYER_SOURCES.otrasNacionalidades : 'data/total_estudiantes_otras_nacionalidades.geojson',
  ieNo: (window.LAYER_SOURCES && window.LAYER_SOURCES.ieNoAtendidas) ? window.LAYER_SOURCES.ieNoAtendidas : 'data/ie_fiscales_no_atendidas.geojson',
  serv: (window.LAYER_SOURCES && window.LAYER_SOURCES.serviciosAguaLuz) ? window.LAYER_SOURCES.serviciosAguaLuz : 'data/servicios_agua_luz.geojson'
};
...
async function loadTopoJSON(url, objectName) {
  ...
  const initial = ['tgProv', 'tgNbi', 'tgViol', 'tgOtras', 'tgIENo', 'tgServ'];
  (async () => {
