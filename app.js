(() => {
  ...
  const GEO = {
    ...
    viol: (window.LAYER_SOURCES && (window.LAYER_SOURCES.violencia || "").trim()) || null,
    otras: (window.LAYER_SOURCES && (window.LAYER_SOURCES.otrasNacionalidades || "").trim()) || null,
    ieNo: (window.LAYER_SOURCES && (window.LAYER_SOURCES.ieNoAtendidas || "").trim()) || null,
    serv: (window.LAYER_SOURCES && (window.LAYER_SOURCES.serviciosAguaLuz || "").trim()) || null,
  };
